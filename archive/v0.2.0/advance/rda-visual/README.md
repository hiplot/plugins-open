...
- ### Function Introduction
    ...
    Redundancy analysis (RDA) is a sort method combining regression analysis with principal component analysis, and it is also an extension of multiple response regression analysis.
